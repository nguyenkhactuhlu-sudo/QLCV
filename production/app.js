...
// ============================================
var CHANGELOG=[
  {date:'2026-09-12',type:'feature',text:'(Đang xây dựng ở bản demo nội bộ, chưa đưa vào bản chạy chính thức) Mục tra cứu đầu việc theo Bảng danh mục KPI dùng chung của VKSND tối cao ngay trong form ghi nhật ký - chọn 1 việc sẽ tự điền "Lĩnh vực công tác" và gợi ý sẵn "Độ phức tạp"; đồng thời đổi danh mục lĩnh vực công tác sang đúng 14 nhóm lĩnh vực của Tối cao (đã lọc bỏ phần chỉ áp dụng ở cấp Tối cao) cộng thêm "Công tác khác", khoá cứng ô này để tránh chọn sai lĩnh vực. Sẽ cập nhật dòng này khi đưa chính thức vào bản chạy thật.'},
