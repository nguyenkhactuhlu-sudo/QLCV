...
// ============================================
var CHANGELOG=[
  {date:'2026-09-12',type:'feature',text:'(Đang thử nghiệm ở bản demo, CHƯA áp dụng lên hệ thống thật) Thêm mục tra cứu đầu việc theo Bảng danh mục KPI dùng chung của VKSND tối cao ngay trong form ghi nhật ký - chọn 1 việc sẽ tự điền "Lĩnh vực công tác" và gợi ý sẵn "Độ phức tạp" (vẫn tự sửa được). Đồng thời đổi danh mục lĩnh vực công tác sang đúng 14 nhóm lĩnh vực của Tối cao (đã lọc bỏ phần chỉ áp dụng ở cấp Tối cao, không có ở tỉnh/khu vực) cộng thêm "Công tác khác"; khoá cứng ô này (không cho chọn tay tuỳ ý) để tránh chọn sai lĩnh vực.'},
...
function populateCategorySelect(){
  ...
  // "Nghi phep" khong hien o day - chi chon duoc qua man hinh rieng "+
  // Ghi nghi phep" (xem submitLeaveLog()), tranh nham lan voi nhat ky
  // cong viec binh thuong.
